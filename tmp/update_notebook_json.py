...
# Define the new code for the DatasetManager cell (index 4)
...
# Update the relevant cell. 'source' in JSON is a list of strings (each ending with \n) or a single string.
# Using a list of strings is more standard for notebooks.
nb['cells'][4]['source'] = [line + '\n' for line in new_code.split('\n')]
# Remove the last trailing newline if it's extra
...
print("Notebook updated successfully using json module.")
